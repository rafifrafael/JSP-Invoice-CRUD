...
<html>
  ...
  <h1>Company Name</h1>
	...
	<form action="./editfood" method="post" class="w-25 mx-auto">
		<div class="container">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="cost" name="cost" value="<%=d.getCost() %>">
			</div>
			<div class="mb-3">
				<a href="./changefoodimg.jsp?id=<%=d.getId()%>" class="btn btn-success">Change Food Image</a>
			</div>
